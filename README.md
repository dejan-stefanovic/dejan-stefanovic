# 💫 About Me:
Actuarial Science grad turned ML Engineer. I build AI systems, currently Project LOGOS, a voice-enabled assistant with a hybrid LLM routing orchestrator. I'm drawn to hard problems, whether that's training models, understanding transformer architectures, or wrapping my head around how gravity bends spacetime. Looking to work on teams pushing the frontier of what AI can do.
